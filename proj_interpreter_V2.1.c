...
int main(void)
{
    ...
    char *filename = "C:/Users/bvattipolu/Downloads/output.txt";
...
int gcode_parse(char *gcode, char *coords[], int len, int diameter_seen) {
    ...
    //if feedrate is not given for g1 or g01 return error
     if(!feedrate_given && feed_rate == 0) {
        printf("feed rate not given for g1\n");
    }
